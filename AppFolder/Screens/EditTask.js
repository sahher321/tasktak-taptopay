...
import { addProject, addTask, APP_URL, GetAllAnnouncement, GetAllAppointments, SetAppointments } from '../Components/Api';
...
const apiPost = async (s) => {
    ...
    axios.post(GetAllAppointments, { "staff_id": UserPermissions.permissions[0].staffid })
        .then(data => {
            // setLoading(false)
...
const EditTask = (props) => {
    ...
    const [defaultPriorityOption, setdefaultPriorityOption] = useState({key: 1, value: "select"});
    ...
    const [defaultFollowersOption, setdefaultFollowersOption] = useState({key: 1, value: "Select"});
    const [date, setDate] = useState("")
    const [location, setLocation] = useState("")
    const [repeat, setrepeat] = useState("")
    const [defaultRepeatOption, setdefaultRepeatOption] = useState({key: 1, value: "Select"});
    const [relatedV, setrelatedV] = useState("")
    const [defaultRelatedOption, setdefaultRelatedOption] = useState({key: 1, value: "Select"});
    ...
    const getTaskDetail = (cdataFinal) => {
        try {
            console.log("RUN")
            var requestOptions = {
                method: 'GET',
            ...
            fetch(APP_URL.BaseUrl + addTask+"/"+taskDetail?.id, requestOptions)
            ...
            .then(result => {
                ...
                // setDeadlineDate(result?.duedate);
                priorityData?.map(val => {
                    if (val.id === parseInt(result.priority)) {
                        setpriority(val.id);
                        setdefaultPriorityOption({key: val.id, value: val.value});
                    }
                });
                repeatData?.map(val => {
                    if (val.id === parseInt(result?.repeat_every)) {
                        setrepeat(val.id);
                        setdefaultRepeatOption({id: val.id, value: val.value});
                    }
                });
                related?.map(val => {
                    if (val.id === parseInt(result?.rel_id)) {
                        setrelatedV(val.id);
                        setdefaultRelatedOption({key: val.id, value: val.value});
                    }
                });
                // cdataFinal?.map(val => {
                //     console.log("cdataFinal value =====> ", val)
                //     return
                //     if (val.key === parseInt(result?.rel_id)) {
                //         setrelatedV(val.id);
                //         setdefaultRelatedOption({key: val.id, value: val.value});
                //     }
                // })
                settotalcycles(result?.total_cycles);
                setSelectedTeams(result?.assignees);
                // settags(result?.)
                setestimatedTime(result?.customfields?.[0].value);
            ...
            <View style={styles.maincontainer} >
                ...
                <ScrollView>
                    ...
                    <View>
                        ...
                        <CustomTextfieldBlank value={subject} setValue={setsubject} style={{ marginTop: 10 }} placeholder="Subject" isSecure={false} />
                    </View>

                    <View style={styles.MarginTop}>
                        <Text style={styles.labelText}>Hourly Rate</Text>
                        <CustomTextfieldBlank value={hourlyrate} setValue={sethourlyrate} style={{ marginTop: 10 }} placeholder="Hourly Rate" isSecure={false} />
                    </View>

                    <View style={styles.MarginTop}>

                        <SingleDatepicker title='Start Date' date={startDate} setDate={setStartDate} />
                    </View>
                    <View style={styles.MarginTop}>
                        <SingleDatepicker title='Due Date' date={deadlineDate} setDate={setDeadlineDate} />
                    </View>
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset defaultOption={defaultPriorityOption} arraydata={priorityData} title='name' value={priority} save={"value"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset defaultOption={defaultRepeatOption} arraydata={repeatData} title='name' value={repeat} save={"value"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <CustomTextfieldBlank value={totalcycles} setValue={settotalcycles} style={{ marginTop: 10 }} placeholder="Total Cycles" isSecure={false} />
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset defaultOption={defaultRelatedOption} arraydata={related} title='name' value={relatedV} save={"value"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Multiselection data={staffmembersdata} selectedTeams={selectedTeams} setSelectedTeams={setSelectedTeams} />
                    </View>
                    <View style={styles.MarginTop}>
                        <Text style={styles.labelText}>
                            Followers
                        ...
                        <Selectset defaultOption={defaultFollowersOption} arraydata={contactata} value={contact} save={"key"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <CustomTextfieldBlank value={tags} setValue={settags} style={{ marginTop: 10 }} placeholder="Tags" isSecure={false} />
                    </View>


                    <View style={styles.MarginTop}>
                        <Text style={styles.labelText}>Estimated Hours</Text>
                        <CustomTextfieldBlank value={estimatedTime} setValue={setestimatedTime} style={{ marginTop: 10 }} placeholder="Estimated Hours" isSecure={false} />
                    </View>
