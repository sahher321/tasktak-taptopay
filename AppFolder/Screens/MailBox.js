  ...
  return (
    <View style={{ flex: 1, marginTop: "5%", alignItems: "center" }}>
      <View style={{ flexDirection: "row" }}>
        <View style={{ flex: 1 }}>
          <Text
            style={{ alignSelf: "flex-start", marginLeft: 20, fontSize: 20 }}
          >
            MailBox
          </Text>
        </View>
        <View style={{ flex: 1 }}>
          ...
          >
            <Text
              style={{ alignSelf: "flex-end", marginRight: 20, fontSize: 20 }}
            >
              Send Mail
            </Text>
          </TouchableOpacity>
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <View
          style={{ flex: 1, alignItems: "flex-start", alignSelf: "center" }}
        >
