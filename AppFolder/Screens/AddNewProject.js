...
import { addProject, APP_URL, GetAllAppointments, SetAppointments } from '../Components/Api';
...
const AddNewProject = () => {
    ...
    const apiAddTask = async () => {
        ...
        try {
          const response = await axios.post(APP_URL.BaseUrl + addProject,
            formData,
            {
              headers: {
            ...
            <View style={styles.maincontainer} >
                ...
                <ScrollView>
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset arraydata={contactata} value={contact} save={"key"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset arraydata={billingTypeData} title='name' value={billingType} save={"value"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset arraydata={projectStatusData} title='name' value={projectStatus} save={"key"}
                            setSelected={(e) => {
