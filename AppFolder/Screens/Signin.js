...
const Signin = () => {
  ...
  const apiPost = async (s) => {
    ...
    axios
      .post("https://nexttak.com" + `${GetSignin}`, data, {
        headers: {
      ...
      .then((data) => {
        ...
        console.log(
          `UserData code = ${JSON.stringify(data.data.staffid, null, 2)}`
        );
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, marginTop: "20%", alignItems: "center" }}>
        ...
        <Text style={{ alignSelf: "flex-start", marginLeft: 20, fontSize: 15 }}>
          Signin To Continue
        </Text>
        ...
        <View style={{ width: "70%", alignItems: "center" }}>
          ...
          <CustomTextfield
            ...
            placeholder="******"
            isSecure={true}
            image={require("../Assets/ic_password.png")}
          />

          <TouchableOpacity style={{ alignSelf: "flex-end", marginTop: 10 }}>
            <Text style={{ color: "lightgray" }}>Forget Password?</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              width: "90%",
