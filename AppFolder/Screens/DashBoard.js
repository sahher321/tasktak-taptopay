...
const Dashboard = (props) => {
  ...
  useEffect(() => {
    ...
    console.log(
      "UserPermissions = =",
      JSON.stringify(UserPermissions.permissions, null, 2)
    );
    ...
    UserPermissions.permissions.map((item, index) => {
      ...
      if (capabilities[item.feature_name] == undefined) {
        ...
        capabilities[item.feature_name]?.permissions?.push(
          item?.capability || ""
        );
      } else {
        capabilities[item.feature_name]?.permissions?.push(
  ...
  let AllPermissionsData = [
    {
      feature_name: "Client",
      icon: require("../Assets/Dashboard/ic_0.png"),
      color: "#0A3ADD",
    },
    {
      feature_name: "MailBox",
      icon: require("../Assets/Dashboard/ic_1.png"),
      color: "#0A3ADD",
    },
    {
      feature_name: "Invoice",
      icon: require("../Assets/Dashboard/ic_3.png"),
      color: "#4f71a0",
    },
    {
      feature_name: "Lead",
      icon: require("../Assets/Dashboard/ic_4.png"),
      color: "#008ece",
    },
    //  { feature_name: "Milestone", icon: require("../Assets/Dashboard/ic_5.png"), color: "#fcb352" },
    {
      feature_name: "Staffs",
      icon: require("../Assets/Dashboard/ic_6.png"),
      color: "#fbe268",
    },
    {
      feature_name: "Project",
      icon: require("../Assets/Dashboard/ic_7.png"),
      color: "#fcb352",
    },
    {
      feature_name: "Task",
      icon: require("../Assets/Dashboard/ic_8.png"),
      color: "#daf7a6",
    },
    {
      feature_name: "Ticket",
      icon: require("../Assets/Dashboard/ic_9.png"),
      color: "#fcb352",
    },
    {
      feature_name: "TimeSheet",
      icon: require("../Assets/Dashboard/ic_12.png"),
      color: "#fbe268",
    },
    {
      feature_name: "Appointly",
      icon: require("../Assets/Dashboard/ic_14.png"),
      color: "#fcb352",
    },
    {
    ...
    },
    {
      ...
      icon: require("../Assets/Dashboard/ic_15.png"),
      color: "#fcb352",
    },
  ];
  ...
  const DashBoardCell = ({ item, index }) => {
    const handleIconPress = () => {
      ...
      if (item.feature_name == "Project") {
        ...
        item.feature_name == "Client" ||
        item.feature_name == "Customer"
      ) {
  ...
  const getAppointmentsHandle = () => {
    try {
      ...
      fetch(
        `${APP_URL.BaseUrl}/api/appointments/getAppointment`,
        requestOptions
      )
        .then((response) => response.json())
        .then((result) => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View
        style={{ flexDirection: "row", paddingTop: 40, paddingVertical: 12 }}
      >
        <View style={{ justifyContent: "center", paddingLeft: 14 }}>
          ...
          <SideBar toggleModal={toggleModal} isModalVisible={isModalVisible} />
        </View>
        <View
        ...
        <View
          style={{ justifyContent: "center", paddingLeft: 14, paddingRight: 7 }}
        >
          <TouchableOpacity
            activeOpacity={0.7}
        ...
        <View
          style={{ justifyContent: "center", paddingRight: 14, paddingLeft: 7 }}
        >
      ...
      <ScrollView>
        <View style={{ padding: 30, flexDirection: "row", flexWrap: "wrap" }}>
