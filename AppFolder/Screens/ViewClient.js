...
const ViewClient = (props) => {
  ...
  const getClientProjects = () => {
    try {
      ...
      fetch(
        APP_URL.BaseUrl + `/api/Clients/getprojects?clientid=${Client_id}`,
        requestOptions
      )
  ...
  const getClientTask = () => {
    try {
      ...
      fetch(
        APP_URL.BaseUrl + `/api/Clients/gettasks/?clientid=${Client_id}`,
        requestOptions
      )
        .then((response) => response.json())
        .then((result) => {
  ...
  const getClientInvoice = () => {
    try {
      ...
      fetch(
        APP_URL.BaseUrl + `/api/Clients/getinvoices/?clientid=${Client_id}`,
        requestOptions
      )
        .then((response) => response.json())
        .then((result) => {
      ...
      <View style={{ flex: 1, marginVertical: "5%" }}>
        <View style={{ flexDirection: "row", paddingHorizontal: 20 }}>
          ...
          <TouchableOpacity
            ...
            onPress={() => handleNewCleintPressed()}
          >
          ...
          {tabsData?.map((val, key) => {
            return (
              <TouchableOpacity
                ...
                style={{
                  marginTop: 16,
                  backgroundColor: tabActive === key ? "#EEE" : "transparent",
                  marginLeft: key === 0 ? 20 : 0,
                  borderRadius: tabActive === key ? 6 : 0,
              ...
              >
                <Text
                  style={{
                    fontSize: 13,
                    color: tabActive === key ? "#4967ff" : "#000",
        ...
        {tabActive === 0 ? (
          <View style={{ paddingHorizontal: 20 }}>
            ...
            <View style={{ flexDirection: "row", paddingTop: "6%" }}>
              <View style={{ flex: 1, justifyContent: "center" }}>
                <Text style={{ fontSize: 16, color: AppTheme.PrimaryColor }}>
                  Company Name:
                </Text>
                <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
                  {clientDetail?.company === null
                    ? "------"
            ...
            <View style={{ flexDirection: "row", paddingTop: "8%" }}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
                  {clientDetail?.city === null ? "------" : clientDetail?.city}
                </Text>
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 16, color: AppTheme.PrimaryColor }}>
            ...
            <View style={{ flexDirection: "row", paddingTop: "8%" }}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
                  {clientDetail?.zip === null ? "------" : clientDetail?.zip}
                </Text>
              </View>
            </View>
          </View>
                  ...
                  >
                    ...
                    <View style={{ flex: 0.5, justifyContent: "center" }}>
                      <Text style={styles.tableRowText}>
                        ...
                        {val?.name.split(" ").length > 3 ? " ..." : ""}
                      </Text>
                    </View>
                    <View style={{ flex: 0.4, justifyContent: "center" }}>
                      <Text style={styles.tableRowText}>
                        {moment(val?.startdate).format("DD-MM-YY")}
                      </Text>
                    </View>
                    <View style={{ flex: 0.4, justifyContent: "center" }}>
                      <Text style={styles.tableRowText}>
