...
import {View, StyleSheet, Text, TextInput, ScrollView, TouchableOpacity, Alert, ActivityIndicator, Image} from 'react-native';
...
const SendMail = () => {
    ...
    const postApiHandle = () => {
        try {
            ...
            fetch(`${APP_URL.BaseUrl}/api/StaffMailbox/sendEmailToStaff`, requestOptions)
        ...
        <View style={styles.maincontainer}>
            <ScrollView>
                ...
                <View style={{marginTop:22}}>
                    <Text style={{fontSize:14,color:"#000",marginBottom:5}}>To</Text>
                    <TextInput
                        value={toEmail}
                        multiline={true}
                        placeholder={'To'}
                        onChangeText={(txt) => setToEmail(txt)}
                        style={{borderColor:"#ccc",borderWidth:1,borderRadius:6,paddingHorizontal:12}}
                    />
                </View>
                <View style={{marginTop:22}}>
                    <Text style={{fontSize:14,color:"#000",marginBottom:5}}>Suject</Text>
                    <TextInput
                        value={subject}
                        multiline={true}
                        placeholder={'Suject'}
                ...
                <View style={{marginTop:22}}>
                    <Text style={{fontSize:14,color:"#000",marginBottom:5}}>Message</Text>
                    <TextInput
                        value={message}
                        multiline={true}
                        placeholder={'Message'}
                ...
                <TouchableOpacity
                    ...
                    borderRadius:4,marginTop:pickedDocument===null?0:12,
                    backgroundColor:pickedDocument===null?"transparent":"#f5f5f5"}}>
                ...
                <TouchableOpacity
                    ...
                    style={{width:"70%",backgroundColor:AppTheme.PrimaryColor,marginTop:20,height:42,borderRadius:6,alignItems:"center",justifyContent:"center",alignSelf:"center"}}>
                    {buttonLoader ? 
