        ...
        <View style={{ flex: 1, alignItems: "center" }}>
            ...
            <View style={{ backgroundColor: "#FFB45C", width: "90%", borderRadius: 5, borderColor: "#DFDFDF", borderWidth: 2, padding: 10, marginTop: 20 }}>
                ...
                <View style={{ justifyContent: 'space-between', marginTop: 5 }}>
                    <Text style={{ fontSize: 18, fontWeight: "bold" }}>{props.category_name}</Text>
                    <Text style={{ fontSize: 16, fontWeight: "bold" }}>{props.expense_name}</Text>
                ...
                <View style={{ flexDirection: "row", justifyContent: 'space-between', marginTop: 5 , marginTop : 20 }}>
                    ...
                    <Text style={{ fontSize: 16, fontWeight: "normal" }}>{props.symbol}{props.amount}</Text>
                </View>
               
                <View style={{ flexDirection: "row", justifyContent: 'space-between', marginTop: 5 }}>
                    <Text style={{ fontSize: 16, fontWeight: "bold" }}>Date: </Text>
                    <Text style={{ fontSize: 16, fontWeight: "normal" }}>{props.date}</Text>
                </View>
