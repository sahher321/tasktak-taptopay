...
import {addTask, APP_URL, GetAllAppointments, SetAppointments } from '../Components/Api';
...
const NewTask = () => {
    ...
    const apiAddPro = async (s) => {
        ...
        axios.post(APP_URL.BaseUrl + addTask,
            // { ...data },
            formData,
        )
            .then(_data => {
    ...
    console.log("Form Data======>",formData)
        try {
          const response = await axios.post(APP_URL.BaseUrl + addTask,
            formData,
            {
              headers: {
      ...
      const fetchRelatedData = async (s) => {
        ...
        axios.post(APP_URL.BaseUrl +'/api/tasks/types/', formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        })
 ...
 fetchRelatedData();
  ...
  const handleSelectChange = (itemValue) => {
    ...
    if (selectedItem) {
      ...
      console.log(`Selected ID: ${selectedItem.id}, Selected Name: ${itemValue}`);
    }
  };
