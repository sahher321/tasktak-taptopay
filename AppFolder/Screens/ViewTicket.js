    ...
    <ScrollView>
      <View style={{ flex: 1, marginVertical: "5%", paddingHorizontal: 20 }}>
        ...
        <View style={{ flex: 1, paddingTop: "6%" }}>
          ...
          <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
            {ticketDetail?.subject === "" ? "------" : ticketDetail?.subject}
          </Text>
        </View>
        <View style={{ flex: 1, paddingTop: "8%" }}>
          ...
          <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
            {ticketDetail?.message === "" ? "------" : ticketDetail?.message}
          </Text>
        </View>
        ...
        <View style={{ flexDirection: "row", paddingTop: "8%" }}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
              {ticketDetail?.user_firstname + " " + ticketDetail?.user_lastname}
            </Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 16, color: AppTheme.PrimaryColor }}>
            ...
            <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
              {ticketDetail?.staff_firstname +
                " " +
                ticketDetail?.staff_lastname}
            </Text>
          </View>
        </View>
      </View>
