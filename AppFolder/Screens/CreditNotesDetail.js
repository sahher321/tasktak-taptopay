  ...
  return (
    <View style={{ flex: 1, alignItems: "center" }}>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 16, fontWeight: "bold" }}>
            {props.item.prefix + props.item.number}
          </Text>
          <Text
            style={{
              fontSize: 16,
        ...
        <Text style={{ fontSize: 16, fontWeight: "normal" }}>
          {props.item.company ? "" : "N/A"}
        </Text>
        <Text style={{ fontSize: 14, fontWeight: "normal", lineHeight: 30 }}>
          Bill To: ABC 1234 sound tech drive Chicago Illinoise US 60680 Ship to:
          1234 sound tech drive Chicago Illinoise US 60680{" "}
        </Text>
        <Text style={{ fontSize: 14, fontWeight: "normal", lineHeight: 30 }}>
          Credit Note Date: {props.item.date}
        </Text>
        ...
        >
          Reference #: {props.item.reference_no}{" "}
        </Text>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 16, fontWeight: "bold" }}>
            Boys Long Shirt White Size 08 yr 2021
          </Text>
          <Text
            style={{
              fontSize: 16,
