...
const ViewInvoice = (props) => {
  ...
  const getInvoiceDetailHandle = () => {
    try {
      ...
      fetch(
        APP_URL.BaseUrl + GetInvoiceDetail + invoiceDetail?.id,
        requestOptions
      )
        ...
        <View style={{ flex: 1, marginVertical: "5%", paddingHorizontal: 20 }}>
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ flex: 1, justifyContent: "center" }}>
              ...
              >{`${dataSource?.prefix} ${dataSource?.number}`}</Text>
            </View>
          </View>
          <View
            style={{
            ...
            return (
              <View
                ...
                style={{
                  ...
                  borderBottomColor: "#ccc",
                  borderBottomWidth:
                    dataSource?.items.length - 1 === key ? 0 : 1,
                  borderBottomLeftRadius:
                    dataSource?.items.length - 1 === key ? 8 : 0,
