...
const CreditNotes = () => {
    ...
    const apiPost = async (s) => {
        ...
        axios.get(APP_URL.BaseUrl +  GetAllCreditNotes)
            .then(data => {
    ...
    return (
       ...
       <View style={{ flex: 1  , alignItems : "center"}}>
            <Text style={{fontSize : 22 , marginLeft : 16 , marginTop : 20 , alignSelf : "flex-start"}}>CreditNotes</Text>
        ...
        <FlatList style ={{ alignSelf : "flex-start", marginTop : 20 , width : "100%"}} renderItem={StaffView} data={dataAllCreditNotes}></FlatList>
...
handleNewProjectPressed = () => {
    ...
    // GoToNextController("CreditNotesDetail")    
      Navigation.push("AppStack", { component: { passProps: { item }, name: "CreditNotesDetail", options: { topBar: { visible: true } } } })
    ...
    return (
        <View style={{ height: 80, flexDirection: "row", flex: 1,borderBottomColor:AppTheme.BorderColor , borderBottomWidth:1 , alignItems: "center"  }}>
            ...
            <View style={{ marginLeft: 15 }}>
                ...
                <TouchableOpacity style={{ alignItems: "flex-end"}} onPress={handleNewProjectPressed}>
            ...
            {/* <Text style={{ fontSize: 15, marginLeft: 5 , marginTop: 3 }}>{"$" + item.total}</Text> */}
                ...
                <Text style={{ fontSize: 15, marginLeft: 5 , marginTop: 3 }}>{"Closed"}</Text>
