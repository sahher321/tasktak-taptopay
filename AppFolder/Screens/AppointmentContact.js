...
import { View, Pressable, Platform, StyleSheet, Text, Image, TextInput, ScrollView, TouchableOpacity } from 'react-native';
...
import { GetAllAnnouncement, GetAllAppointments, SetAppointments } from '../Components/Api';
  ...
  return (
    <>
      <View style={styles.maincontainer} >
        ...
        <ScrollView>
          <View>
            <InputField title='Subject' name="subject" value={subject} onChange={(e) => { setsubject(e.target.value) }} />
          </View>
          ...
          <View style={styles.MarginTop}>
            ...
            <Selectset arraydata={mainData} title='name' selected={related} setSelected={setRelated} value={subject} onChange={async (e) => {
          ...
          <View style={styles.MarginTop}>
            {related == "lead_related" ?
              (<>
                ...
                <Selectset arraydata={leadsData} value={leads} onChange={(e) => { setLeads(e) }} />
              </>) : null
            }
          ...
          <View style={styles.MarginTop}>
            {related == "internal" ?
              (<>
                ...
                <Selectset arraydata={contactata} value={leads} onChange={(e) => { setLeads(e) }} />
              </>) : null
            }

          </View>
          <View >
            <InputField title='Name' value={name} onChange={(e) => { setName(e) }} />
          </View>
          <View >
            <InputField title='Email ' value={email} onChange={(e) => { setEmail(e) }} />
          </View>
          <View >
            <PhoneInput title='Phone (Ex: +1 69 1234 5678) ' value={phone} onChange={(e) => { setPhone(e.target.value) }} />
          </View>
          <View >
            <PhoneInput title='Contact' value={phone} onChange={(e) => { setPhone(e) }} />
          </View>
          <View style={styles.MarginTop}>
            {/* <SingleDatepicker /> */}
          ...
          <View style={styles.MarginTop}>
            ...
            <Selectset arraydata={appointmentTypetata} value={leads} onChange={(e) => { setLeads(e) }} />
