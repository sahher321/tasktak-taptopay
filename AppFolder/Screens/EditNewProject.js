...
import { addProject, APP_URL, GetAllAnnouncement, GetAllAppointments, GetProjectDetail, SetAppointments } from '../Components/Api';
...
const EditNewProject = (props) => {
    ...
    const [defaultContactOption, setdefaultContactOption] = useState({key: "1", value: "Select"});
    const [defaultBillingtOption, setdefaultBillingOption] = useState({key: "1", value: "Select"});
    const [defaultProjecttOption, setdefaultProjectOption] = useState({key: "1", value: "Select"});
    ...
    const updateProjectHandle = () => {
        try {
            ...
            fetch(APP_URL.BaseUrl + addProject+"/"+projectDetail?.id, requestOptions)
            .then(response => response.json())
            .then(result => {
            ...
            <View style={styles.maincontainer} >
                ...
                <ScrollView>
                    ...
                    <View>
                        ...
                        <CustomTextfieldBlank value={proName} setValue={setProName} style={{ marginTop: 10 }} placeholder="Project Name" isSecure={false} />
                    </View>
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        arraydata={billingTypeData} title='name' value={billingType} save={"value"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <Selectset defaultOption={defaultProjecttOption} arraydata={projectStatusData} title='name' value={projectStatus} save={"key"}
                            setSelected={(e) => {
                    ...
                    <View style={styles.MarginTop}>
                        ...
                        <CustomTextfieldBlank value={totalRate} setValue={settotalRate} style={{ marginTop: 10 }} placeholder="Total Rate" isSecure={false} />
                    </View>
                    ...
                    <View style={styles.MarginTop}>
                        <SingleDatepicker title='Deadline' date={deadlineDate} setDate={setDeadlineDate} />
                    </View>
