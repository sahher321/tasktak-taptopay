...
const Proposals = () => {
  ...
  const apiPost = async (s) => {
    ...
    axios
      .get(APP_URL.BaseUrl + GetAllProposals, { keysearch: "" })
      .then((data) => {
        setLoading(false);
  ...
  return (
    <TouchableOpacity>
      ...
      >
        ...
        >
          {"Total: " + item.symbol + item.total || "N/A"}
        </Text>
