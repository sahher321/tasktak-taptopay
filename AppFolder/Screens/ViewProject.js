...
const ViewProject = (props) => {
  ...
  const getTaskDetail = (project_id) => {
    try {
      ...
      fetch(
        `${APP_URL.BaseUrl}/api/ProjectsTasks/getprojectstasks/?projectid=${project_id}`,
        requestOptions
      )
        .then((response) => response.json())
        .then((result) => {
  ...
  const getMemberDetail = (project_id) => {
    try {
      ...
      fetch(
        `${APP_URL.BaseUrl}/api/Clients/getProjectMembers/?projectid=${project_id}`,
        requestOptions
      )
        .then((response) => response.json())
        .then((result) => {
            ...
            {tabsData?.map((val, key) => {
              return (
                <TouchableOpacity
                  ...
                  style={{
                    backgroundColor: tabActive === key ? "#ffd21f" : "gray",
            ...
            <View style={{ marginTop: "8%", paddingHorizontal: 20 }}>
              ...
              >
                ...
                <View style={{ justifyContent: "center" }}>
                  ...
                  >
                    {}
                    {dataSource?.billing_type === "1"
                      ? "Fixed Rate"
                      : dataSource?.billing_type === "2"
                        ? "Project Hours"
                        : dataSource?.billing_type === "3"
                  ...
                  >
                    ...
                    <View style={{ flexDirection: "row", marginTop: 18 }}>
                      ...
                      >
                        ...
                        >
                          <Text>{"Deadline: "}</Text>
                          <Text style={{ color: "red" }}>{val?.duedate}</Text>
                        </Text>
                      </View>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    <View style={{ flexDirection: "row", marginTop: 18 }}>
                      ...
                      >
                        ...
                        >
                          <Text>{"Note: "}</Text>
                          <Text style={{ color: "green" }}>{val?.note}</Text>
                        </Text>
                      </View>
                    </View>
                  </View>
