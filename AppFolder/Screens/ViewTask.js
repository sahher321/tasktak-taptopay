      ...
      <View style={{ flex: 1, marginVertical: "5%", paddingHorizontal: 20 }}>
        ...
        <View style={{ flexDirection: "row", paddingTop: "6%" }}>
          <View style={{ flex: 1, justifyContent: "center" }}>
            ...
            <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
              {projectDetail?.name === null ? "------" : projectDetail?.name}
            </Text>
          </View>
          <View style={{ flex: 1, justifyContent: "center" }}>
            <Text style={{ fontSize: 16, color: AppTheme.PrimaryColor }}>
        ...
        <View style={{ flexDirection: "row", paddingTop: "8%" }}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
              {projectDetail?.project_cost === null
                ? "------"
                : projectDetail?.project_cost}
            </Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 16, color: AppTheme.PrimaryColor }}>
            ...
            <Text style={{ fontSize: 14, textTransform: "capitalize" }}>
              {projectDetail?.estimated_hours === null
                ? "------"
                : projectDetail?.estimated_hours}
            </Text>
          </View>
        </View>
        <View style={{ flexDirection: "row", paddingTop: "8%" }}>
